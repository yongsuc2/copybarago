...
const ENEMY_TEMPLATES: EnemyTemplateData[] = [
  { id: 'slime', name: 'Slime', baseStats: Stats.create({ hp: 60, maxHp: 60, atk: 6, def: 2 }), skillIds: [], isBoss: false, ragePerAttack: 35 },
  { id: 'goblin', name: 'Goblin', baseStats: Stats.create({ hp: 80, maxHp: 80, atk: 10, def: 3 }), skillIds: [], isBoss: false, ragePerAttack: 30 },
  ...
  { id: 'elite_mage', name: 'Dark Mage', baseStats: Stats.create({ hp: 120, maxHp: 120, atk: 22, def: 4 }), skillIds: ['lightning'], isBoss: false, ragePerAttack: 20 },

  { id: 'boss_dragon', name: 'Ancient Dragon', baseStats: Stats.create({ hp: 500, maxHp: 500, atk: 25, def: 12 }), skillIds: ['lightning'], isBoss: true, ragePerAttack: 15 },
  { id: 'boss_demon', name: 'Demon Lord', baseStats: Stats.create({ hp: 400, maxHp: 400, atk: 30, def: 8 }), skillIds: ['poison_weapon', 'lifesteal'], isBoss: true, ragePerAttack: 15 },
  { id: 'boss_golem', name: 'Stone Golem', baseStats: Stats.create({ hp: 700, maxHp: 700, atk: 18, def: 20 }), skillIds: ['counter', 'iron_shield'], isBoss: true, ragePerAttack: 15 },
];
