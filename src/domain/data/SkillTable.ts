...
const ALL_SKILLS: Skill[] = [
  ...
  new Skill('sword_aura', 'Sword Aura', SkillGrade.NORMAL, SkillCategory.ATTACK,
  ...
  new Skill('counter', 'Counter Attack', SkillGrade.NORMAL, SkillCategory.ATTACK,
  ...
  new Skill('hp_proficiency', 'HP Proficiency', SkillGrade.LEGENDARY, SkillCategory.PROFICIENCY,
    [], makeEffect(EffectType.BUFF, 0.1, 99, StatusEffectType.DEF_UP), TriggerCondition.PASSIVE),

  new Skill('atk_proficiency', 'ATK Proficiency', SkillGrade.LEGENDARY, SkillCategory.PROFICIENCY,
    [], makeEffect(EffectType.BUFF, 0.1, 99, StatusEffectType.ATK_UP), TriggerCondition.PASSIVE),

  new Skill('def_proficiency', 'DEF Proficiency', SkillGrade.LEGENDARY, SkillCategory.PROFICIENCY,
    [], makeEffect(EffectType.BUFF, 0.1, 99, StatusEffectType.DEF_UP), TriggerCondition.PASSIVE),

  new Skill('crit_proficiency', 'CRIT Proficiency', SkillGrade.LEGENDARY, SkillCategory.PROFICIENCY,
  ...
  new Skill('thunderstorm', 'Thunderstorm', SkillGrade.MYTHIC, SkillCategory.ATTACK,
