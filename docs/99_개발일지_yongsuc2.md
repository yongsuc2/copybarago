...
- **적 HP 비례 물리 공격 + 기절 스킬** (Y-39) — 분쇄(hp_crush): 적 maxHP 비례 물리 데미지(isTargetHpBased), SKULL 시너지 / 강타(stun_strike): 물리 공격+확률 기절(STUN 상태효과 신규), KNIGHT 시너지, processEnemyTurn 기절 체크
